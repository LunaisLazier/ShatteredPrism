...
if command -v "svgo"; then
    svgo org.fracturedprism.FracturedPrism.Source.svg -o org.fracturedprism.FracturedPrism.svg
else
...
if command -v "inkscape" && command -v "icotool"; then
    ...
    svg2png org.fracturedprism.FracturedPrism.svg "$d/fracturedprism_16.png" 16 16
    svg2png org.fracturedprism.FracturedPrism.svg "$d/fracturedprism_24.png" 24 24
    svg2png org.fracturedprism.FracturedPrism.svg "$d/fracturedprism_32.png" 32 32
    svg2png org.fracturedprism.FracturedPrism.svg "$d/fracturedprism_48.png" 48 48
    svg2png org.fracturedprism.FracturedPrism.svg "$d/fracturedprism_64.png" 64 64
    svg2png org.fracturedprism.FracturedPrism.svg "$d/fracturedprism_128.png" 128 128
    svg2png org.fracturedprism.FracturedPrism.svg "$d/fracturedprism_256.png" 256 256

    rm shatteredprism.ico && icotool -o shatteredprism.ico -c \
        "$d/fracturedprism_256.png"  \
        "$d/fracturedprism_128.png"  \
        "$d/fracturedprism_64.png"   \
        "$d/fracturedprism_48.png"   \
        "$d/fracturedprism_32.png"   \
        "$d/fracturedprism_24.png"   \
        "$d/fracturedprism_16.png"
else
...
if command -v "inkscape" && command -v "magick"; then
    ...
    magick convert "$d"/* fracturedprism.icns
else
...
cp -v org.fracturedprism.FracturedPrism.svg "../launcher/resources/multimc/scalable/launcher.svg"
